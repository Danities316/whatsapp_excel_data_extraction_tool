# STEP 1: Use Puppeteer’s base image — already includes Chromium and all dependencies
...
ENV PORT=8888
# Puppeteer already bundles Chromium in this base image
ENV PUPPETEER_EXECUTABLE_PATH="/usr/bin/chromium"

# STEP 6: Expose port
EXPOSE 8888

# STEP 7: Healthcheck (optional for Render)
HEALTHCHECK --interval=30s --timeout=5s --start-period=20s \
    CMD curl -f http://localhost:8888/ || exit 1

# STEP 8: Start API and Bot
CMD ["npm", "start"]
